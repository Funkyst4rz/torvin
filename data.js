...
const CLERIC_SPELLS = {
  0: [
    ...
    { id:'lightningLure', name:'Lasso de foudre',     tag:'DD For',     conc:false, cast:'1 action',  range:'9 m',          dur:'Instantanée', wizard:true, desc:"Attire une créature à portée 9 m vers vous de 3 m : 1d8 foudre si elle se retrouve dans un rayon de 1,5 m. (SCAG)" },
  ...
  2: [
    { id:'aid',           name:'Aide',                      tag:'+5 PV',      conc:false, cast:'1 action',  range:'Contact',      dur:'8 heures',    desc:"3 alliés gagnent +5 PV max et actuels pendant 8 heures.", upcast:"+5 PV supplémentaires par niveau d'emplacement supérieur au niv.2." },
  ...
  5: [
    ...
    { id:'masscure',      name:'Soins de groupe supérieurs',tag:'soin',       conc:false, cast:'1 action',  range:'9 m',          dur:'Instantanée', desc:"Jusqu'à 6 créatures dans 9 m récupèrent 3d8 + mod Sag PV.", upcast:"+1d8 PV par niveau d'emplacement supérieur au niv.5." },
